...
export const metadata: Metadata = {
    ...
    description: 'Learn about Weaszel\'s experimental desktop control feature, its capabilities, limitations, and when to use it.',
};
                    ...
                    <article className="bg-[#0c0a09] border border-amber-900/30 rounded-2xl p-8 md:p-12">
                        ...
                        <div className="prose prose-invert prose-stone max-w-none">
                            <p className="text-xl text-stone-400 leading-relaxed mb-6">
                                Weaszel includes an experimental desktop control feature that extends beyond browser automation.
                                This opens up powerful new possibilities, but it comes with important caveats you need to understand.
                            </p>
                            ...
                            <p className="text-stone-400 mb-4">
                                To enable Desktop Control, set <code className="bg-black/50 px-2 py-1 rounded text-amber-400">EXPERIMENTAL_DESKTOP_ENABLED=true</code> in your <code className="bg-black/50 px-2 py-1 rounded text-amber-400">.env.local</code> file.
                            </p>
                            <div className="bg-black/50 rounded-lg p-6 mb-6 font-mono text-sm border border-stone-800">
                                <p className="text-green-400 mb-2"># In .env.local</p>
                                <p className="text-amber-400">EXPERIMENTAL_DESKTOP_ENABLED=true</p>
                            </div>
                            <p className="text-stone-400 mb-6">
